...
const UIStrings = {
  ...
  description: 'Assistive technologies, like screen readers, work inconsistently when `aria-hidden="true"` is set on the document `<body>`. [Learn how to make document body accessible](https://dequeuniversity.com/rules/axe/4.4/aria-hidden-body).',
};
