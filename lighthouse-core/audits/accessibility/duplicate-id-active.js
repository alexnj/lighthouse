...
const UIStrings = {
  ...
  description: 'All focusable elements must have a unique `id` to ensure that they\'re visible to assistive technologies. [Learn more about id attribute](https://dequeuniversity.com/rules/axe/4.4/duplicate-id-active).',
};
