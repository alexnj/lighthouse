...
const UIStrings = {
  ...
  description: 'The value of an ARIA ID must be unique to prevent other instances from being overlooked by assistive technologies. [Learn more about ARIA IDs](https://dequeuniversity.com/rules/axe/4.4/duplicate-id-aria).',
};
