...
const UIStrings = {
  ...
  description: 'All front-end JavaScript libraries detected on the page. [Learn more about JavaScript library detection diagnostic audit](https://web.dev/js-libraries/).',
