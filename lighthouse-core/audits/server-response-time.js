...
const UIStrings = {
  ...
  description: 'Keep the server response time for the main document short because all other requests depend on it. [Learn more about Time to First Byte metric](https://web.dev/time-to-first-byte/).',
