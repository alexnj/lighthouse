...
const UIStrings = {
  ...
  description: 'Set an explicit width and height on image elements to reduce layout shifts and improve CLS. [Learn more about image dimensions](https://web.dev/optimize-cls/#images-without-dimensions)',
};
