...
const UIStrings = {
  ...
  description: 'This is the thread-blocking work occurring during the Interaction to Next Paint measurement. [Learn more about Interaction to Next Paint metric](https://web.dev/inp/).',
